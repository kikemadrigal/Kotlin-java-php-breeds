        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link active" href="<?php echo PATHSERVER."Home/about" ?>">About</a></li>
                    <li class="nav-item"><a class="nav-link active" href="<?php echo PATHSERVER."Home/whatis" ?>">What is</a></li>
                    <li class="nav-item"><a class="nav-link active" href="<?php echo PATHSERVER."Home/license" ?>">License</a></li>
                    <li class="nav-item"><a class="nav-link active" href="https://play.google.com/store/apps/details?id=es.tipolisto.breeds">Download</a></li>
                <!--CONTROL DE USUARIOS -->
